...
fn build_uniforms(angle_radians: f32, aspect: f32) -> Uniforms {
    ...
    // perspective_rh, not perspective_rh_gl -- wgpu's depth range is 0..1,
    // unlike the GL convention (-1..1) your old mat4_perspective assumed.
...
pub fn render_frame(state: &mut RenderState, angle_radians: f32) {
    ...
    let surface_texture = match state.surface.get_current_texture() {
        ...
        wgpu::CurrentSurfaceTexture::Lost => return, // caller re-creates on next resize/frame
    };
